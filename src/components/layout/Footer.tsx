         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
           ...
           <div>
             ...
             <p className="text-sm text-muted-foreground mb-4">
               Your trusted partner for all printing solutions. Quality products, reliable service, and expert support since 2015.
             </p>
           ...
           <div>
             ...
             <ul className="space-y-3 text-sm">
               ...
               <li className="flex items-center gap-3">
                 ...
                 <span className="text-muted-foreground">+1-877-419-4506</span>
               </li>
               <li className="flex items-center gap-3">
                 <Mail className="h-5 w-5 text-primary flex-shrink-0" />
                 <span className="text-muted-foreground">support@printerfix.shop</span>
               </li>
             </ul>
           </div>
         </div>
